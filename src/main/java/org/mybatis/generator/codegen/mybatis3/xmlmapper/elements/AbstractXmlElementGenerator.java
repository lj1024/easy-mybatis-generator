...
public abstract class AbstractXmlElementGenerator extends AbstractGenerator {
     ...
     */
    protected XmlElement getQueryFilterIncludeElement() {
        XmlElement includeElement = new XmlElement("include"); //$NON-NLS-1$
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getMybatis3QueryFilterId()));
     ...
     * @author <a href="mailto:luwenjie@knet.cn">芦文杰</a>
     */
    protected XmlElement getSetFilterIncludeElement() {
        XmlElement includeElement = new XmlElement("include"); //$NON-NLS-1$
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getMybatis3SetFilterId()));
        return includeElement;
    }
     ...
     * @author <a href="mailto:luwenjie@knet.cn">芦文杰</a>
     */
    protected XmlElement getOrderFilterIncludeElement() {
        XmlElement includeElement = new XmlElement("include"); //$NON-NLS-1$
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getMybatis3OrderFilterId()));
        return includeElement;
    }
    
    protected XmlElement getPageMySqlFilterIncludeElement() {
        XmlElement includeElement = new XmlElement("include"); //$NON-NLS-1$
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getMybatis3MysqlFilterId()));
        return includeElement;
    }
    
    protected XmlElement getPageOracleBeforeFilterIncludeElement() {
        XmlElement includeElement = new XmlElement("include"); //$NON-NLS-1$
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getMybatis3OracleBeforeFilterId()));
        return includeElement;
    }
    
    protected XmlElement getPageOracleAfterFilterIncludeElement() {
        XmlElement includeElement = new XmlElement("include"); //$NON-NLS-1$
        includeElement.addAttribute(new Attribute("refid", //$NON-NLS-1$
                introspectedTable.getMybatis3OracleAfterFilterId()));
        return includeElement;
    }
