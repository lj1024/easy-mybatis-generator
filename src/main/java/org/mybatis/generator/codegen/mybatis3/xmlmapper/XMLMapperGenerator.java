...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.PageElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.QueryElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.QueryFilterSQLGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ReadElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ReadOneElementGenerator;
...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SetFilterSQLGenerator;
...
//        addResultMapWithBLOBsElement(answer);
        addQueryFilterSQLElement(answer);
        addSetFilterSQLElement(answer);
        addInsertElement(answer);
        addDeleteElement(answer);
        addUpdateElement(answer);
        addReadElement(answer);
        addReadOneElement(answer);
        addQueryElement(answer);
        addCountElement(answer);
        addPageElement(answer);
    ...
    //新增 queryFilter,setFilter,orderFilter add by lwj 2015-10-13
    protected void addQueryFilterSQLElement(XmlElement parentElement) {
            AbstractXmlElementGenerator elementGenerator = new QueryFilterSQLGenerator(false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addSetFilterSQLElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new SetFilterSQLGenerator(false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    
    // 新增删除,更新,读取单条，读取多条数据  add by lwj 2015-10-13
    ...
    protected void addReadElement(XmlElement parentElement) {
            AbstractXmlElementGenerator elementGenerator = new ReadElementGenerator(false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addReadOneElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new ReadOneElementGenerator(false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
   }
    
    protected void addQueryElement(XmlElement parentElement) {
            AbstractXmlElementGenerator elementGenerator = new QueryElementGenerator(false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addCountElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new CountElementGenerator(false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
    
    protected void addPageElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new PageElementGenerator(false);
        initializeAndExecuteGenerator(elementGenerator, parentElement);
    }
