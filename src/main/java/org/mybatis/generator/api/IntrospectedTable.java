...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		...
		ATTR_QUERY_STATEMENT_ID, 
		ATTR_READ_STATEMENT_ID, 
		ATTR_COUNT_STATEMENT_ID, 
		ATTR_PAGE_STATEMENT_ID, 
		...
		ATTR_QUERY_FILTER_ID, 
		ATTR_SET_FILTER_ID, 
		ATTR_ORDER_FILTER_ID,
		ATTR_MYSQL_FILTER_ID,
		ATTR_ORACLE_BEFORE_FILTER_ID,
		ATTR_ORACLE_AFTER_FILTER_ID,
		ATTR_READONE_STATEMENT_ID;
	...
	protected void calculateXmlAttributes() {
		...
		setReadStatementId("read");
		setReadOneStatementId("readOne");
		setQueryStatementId("query");
		setCountStatementId("count");
		setPageStatementId("page");
		...
		// 新增 update query order 条件过滤 add by lwj 2015-10-13
		setMybatis3SetFilterId("SetFilter");
		setMybatis3QueryFilterId("QueryFilter");
		setMybatis3OrderFilterId("PUBLIC.OrderFilter");
		setMybatis3MysqlFilterId("PUBLIC.Mysql");
		setMybatis3OracleBeforeFilterId("PUBLIC.OracleBefore");
		setMybatis3OracleAfterFilterId("PUBLIC.OracleAfter");
	}

	private void setReadOneStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_READONE_STATEMENT_ID, s);
	}
	...
	public void setReadStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_READ_STATEMENT_ID, s);
	}
	public void setQueryStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_QUERY_STATEMENT_ID, s);
	}
	public void setCountStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_COUNT_STATEMENT_ID, s);
	}
	public void setPageStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_PAGE_STATEMENT_ID, s);
	}
	...
	public void setMybatis3QueryFilterId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_QUERY_FILTER_ID, s);
	}

	public void setMybatis3SetFilterId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_SET_FILTER_ID, s);
	}

	public void setMybatis3OrderFilterId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_ORDER_FILTER_ID, s);
	}
	
	public void setMybatis3MysqlFilterId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_MYSQL_FILTER_ID, s);
	}
	
	public void setMybatis3OracleBeforeFilterId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_ORACLE_BEFORE_FILTER_ID, s);
	}
	
	public void setMybatis3OracleAfterFilterId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_ORACLE_AFTER_FILTER_ID, s);
	}
	...
	public String getReadStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_READ_STATEMENT_ID);
	}
	
	public String getReadOneStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_READONE_STATEMENT_ID);
	}

	public String getQueryStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_QUERY_STATEMENT_ID);
	}

	public String getCountStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_COUNT_STATEMENT_ID);
	}

	public String getPageStatementId() {
		return internalAttributes.get(InternalAttribute.ATTR_PAGE_STATEMENT_ID);
	}
	...
	public String getMybatis3QueryFilterId() {
		return internalAttributes.get(InternalAttribute.ATTR_QUERY_FILTER_ID);
	}

	public String getMybatis3SetFilterId() {
		return internalAttributes.get(InternalAttribute.ATTR_SET_FILTER_ID);
	}

	public String getMybatis3OrderFilterId() {
		return internalAttributes.get(InternalAttribute.ATTR_ORDER_FILTER_ID);
	}
	
	public String getMybatis3MysqlFilterId() {
		return internalAttributes.get(InternalAttribute.ATTR_MYSQL_FILTER_ID);
	}
	
	public String getMybatis3OracleBeforeFilterId() {
		return internalAttributes.get(InternalAttribute.ATTR_ORACLE_BEFORE_FILTER_ID);
	}
	
	public String getMybatis3OracleAfterFilterId() {
		return internalAttributes.get(InternalAttribute.ATTR_ORACLE_AFTER_FILTER_ID);
	}
